...
# java
#RUN curl -LO 'http://static.imply.io/jdk/jdk-8u161-linux-x64.rpm' -H 'Cookie: oraclelicense=accept-securebackup-cookie'
...
#RUN curl -Ls http://dl.bintray.com/sequenceiq/sequenceiq-bin/hadoop-native-64-2.7.3.tar | tar -x -C /tmp/native
#RUN curl -Ls https://static.imply.io/hadoop/native/hadoop-native-64-2.7.3.tar | tar -x -C /tmp/native
